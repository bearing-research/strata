...
- **`agent_demo` example + a README demo of a coding agent building a notebook
  live.** A small, runnable notebook (`examples/agent_demo/`) that trains a model
  ...
  exact `strata agent` flow behind the README GIF.
