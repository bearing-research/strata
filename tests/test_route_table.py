...
EXPECTED_ROUTES = [
    ...
    ("/v1/artifacts/import/blobs/{content_sha256}", "PUT", 0),
    ...
    ("/v1/artifacts/{artifact_id}/v/{version}/publish", "POST", 1),
    ...
    ("/v1/notebooks/config", "GET", 1),
    ("/v1/notebooks/create", "POST", 1),
    ("/v1/notebooks/delete-by-path", "POST", 1),
    ("/v1/notebooks/discover", "GET", 1),
    ("/v1/notebooks/import", "POST", 1),
    ("/v1/notebooks/import-snapshot", "POST", 1),
    ("/v1/notebooks/open", "POST", 1),
    ("/v1/notebooks/recents/validate", "POST", 1),
    ("/v1/notebooks/sessions", "GET", 1),
    ("/v1/notebooks/sessions/{session_id}", "GET", 1),
    ("/v1/notebooks/{notebook_id}", "DELETE", 1),
    ("/v1/notebooks/{notebook_id}/ai/agent", "POST", 1),
    ("/v1/notebooks/{notebook_id}/ai/agent/reset", "POST", 1),
    ("/v1/notebooks/{notebook_id}/ai/complete", "POST", 1),
    ("/v1/notebooks/{notebook_id}/ai/model", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/ai/models", "GET", 1),
    ("/v1/notebooks/{notebook_id}/ai/status", "GET", 1),
    ("/v1/notebooks/{notebook_id}/ai/stream", "POST", 1),
    ("/v1/notebooks/{notebook_id}/artifacts", "GET", 1),
    ("/v1/notebooks/{notebook_id}/artifacts/{artifact_id}/v/{version}/promote", "POST", 1),
    ("/v1/notebooks/{notebook_id}/cells", "GET", 1),
    ("/v1/notebooks/{notebook_id}/cells", "POST", 1),
    ...
    ("/v1/notebooks/{notebook_id}/cells/{cell_id}/execute", "POST", 1),
    ("/v1/notebooks/{notebook_id}/cells/{cell_id}/iterations", "GET", 1),
    ...
    ("/v1/notebooks/{notebook_id}/dag", "GET", 1),
    ("/v1/notebooks/{notebook_id}/dependencies", "GET", 1),
    ("/v1/notebooks/{notebook_id}/dependencies", "POST", 1),
    ("/v1/notebooks/{notebook_id}/dependencies/{package_name}", "DELETE", 1),
    ("/v1/notebooks/{notebook_id}/env", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/environment", "GET", 1),
    ("/v1/notebooks/{notebook_id}/environment/environment.yaml", "POST", 1),
    ("/v1/notebooks/{notebook_id}/environment/environment.yaml/preview", "POST", 1),
    ("/v1/notebooks/{notebook_id}/environment/jobs", "POST", 1),
    ("/v1/notebooks/{notebook_id}/environment/jobs/current", "GET", 1),
    ("/v1/notebooks/{notebook_id}/environment/requirements.txt", "GET", 1),
    ("/v1/notebooks/{notebook_id}/environment/requirements.txt", "POST", 1),
    ("/v1/notebooks/{notebook_id}/environment/requirements.txt/preview", "POST", 1),
    ("/v1/notebooks/{notebook_id}/environment/sync", "POST", 1),
    ("/v1/notebooks/{notebook_id}/export", "GET", 1),
    ("/v1/notebooks/{notebook_id}/mounts", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/name", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/python-version", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/quiesce", "POST", 1),
    ("/v1/notebooks/{notebook_id}/r-packages", "GET", 1),
    ("/v1/notebooks/{notebook_id}/release", "POST", 1),
    ("/v1/notebooks/{notebook_id}/secret-manager/config", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/secret-manager/refresh", "POST", 1),
    ("/v1/notebooks/{notebook_id}/timeout", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/variant-groups/{group_id}", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/variant-groups/{group_id}/variants", "POST", 1),
    ("/v1/notebooks/{notebook_id}/worker", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/workers", "GET", 1),
    ("/v1/notebooks/{notebook_id}/workers", "PUT", 1),
    ("/v1/notebooks/{notebook_id}/workers/ssh", "GET", 1),
    ("/v1/notebooks/{notebook_id}/workers/ssh", "POST", 1),
    ("/v1/notebooks/{notebook_id}/workers/ssh/{worker_name}", "DELETE", 1),
    ("/v1/projects/{path:path}/quiesce", "POST", 1),
    ("/v1/projects/{path:path}/release", "POST", 1),
    ("/v1/publications", "GET", 0),
    ("/v1/publications/{token}", "DELETE", 1),
    ("/v1/publications/{token}", "GET", 0),
    ("/v1/publications/{token}", "PATCH", 1),
