...
EXPECTED_ROUTES = [
    ...
    ("/v1/notebooks/{notebook_id}/cells/{cell_id}/tests", "PUT", 0),
    ...
    ("/v1/notebooks/{notebook_id}/quiesce", "POST", 0),
    ("/v1/notebooks/{notebook_id}/r-packages", "GET", 0),
    ("/v1/notebooks/{notebook_id}/release", "POST", 0),
    ...
    ("/v1/notebooks/{notebook_id}/workers/ssh", "GET", 0),
    ("/v1/notebooks/{notebook_id}/workers/ssh", "POST", 0),
    ("/v1/notebooks/{notebook_id}/workers/ssh/{worker_name}", "DELETE", 0),
    ("/v1/projects/{path:path}/quiesce", "POST", 0),
    ("/v1/projects/{path:path}/release", "POST", 0),
